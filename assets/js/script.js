 ...
 * ad after the user's answer has been processed
 */
...
function runGame(gameType) {
    ...
    if (gameType === "addition") {
        ...
        diaplaySubstractQuestion(num1, num2);
    } else {
...
function checkAnswer() {
    ...
    if (isCorrect) {
        ...
        alert(`Nope... you answered ${userAnswer}, the correct answer was ${calculateAnswer[0]}!`)
...
/**
 * Gets the current incorrect score from the DOM and incements it by 1
 */
...
function diaplaySubstractQuestion(operand1, operand2) {
